...
export interface UpcomingResponse extends Response<Movie> {
  dates: { maximum: string; minimum: string };
}

export interface MultiSearchResult extends Movie {
...
export interface MovieDetail extends Movie {
  ...
  similar: Response<Movie>;
  videos: Videos;
  release_dates: ReleaseDates;
  keywords: Keywords;
  recommendations: Response<Movie>;
}
